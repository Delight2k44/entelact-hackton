...
# Step 9 (Ticks 495..498): Final precision touches - ensure 100% presence of all species!
safe_top = get_clean_cells(0, 3)
add(495, [{"plant_index": 2, "index": 2, "row": r, "col": c} for r, c in safe_top[:20]])       # 20 Rose Bush
add(496, [{"plant_index": 6, "index": 6, "row": r, "col": c} for r, c in safe_top[20:40]])      # 20 Lavender
add(497, [{"plant_index": 16, "index": 16, "row": r, "col": c} for r, c in safe_top[40:60]])    # 20 Ironthorn Shrub
add(498, [{"plant_index": 15, "index": 15, "row": r, "col": c} for r, c in safe_top[60:80]])    # 20 Moonpetal Lily
