...
# Step 8 (Ticks 467..494): Mid-late cultivation
...
# Step 9 (Ticks 495..498): Final precision touches on 100% UNTOUCHED FRESH SOIL (cols 76..95)!
add(495, [{"plant_index": 2, "index": 2, "row": 1, "col": c} for c in range(76, 96)])   # 20 Rose Bush on fresh soil!
add(496, [{"plant_index": 6, "index": 6, "row": 2, "col": c} for c in range(76, 96)])   # 20 Lavender on fresh soil!
add(497, [{"plant_index": 16, "index": 16, "row": 3, "col": c} for c in range(76, 96)]) # 20 Ironthorn Shrub on fresh soil!
add(498, [{"plant_index": 15, "index": 15, "row": 4, "col": c} for c in range(76, 96)]) # 20 Moonpetal Lily on fresh soil!

print(f"Total actions scheduled up to tick: 498")
