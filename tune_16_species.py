...
# Distribute across the 16 species (40 plants each = 2 ticks per species = 32 ticks!)
clay_cells = [(r, c) for r in range(70) for c in range(100) if is_clay(r, c)]

late_16 = [
    (6, get_clean_cells(0, 2)),      # Lavender
    (2, get_clean_cells(2, 4)),      # Rose Bush
    (7, get_clean_cells(11, 13)),    # Orange Blossom
    ...
    (16, get_clean_cells(47, 50)),   # Ironthorn Shrub
    (18, clay_cells),                # Mire Bloom
    (19, get_clean_cells(51, 55)),   # Razorgrass
    (20, get_clean_cells(56, 59)),   # Skyvine
    (27, get_clean_cells(24, 26)),   # Living Topiary
    (4, get_clean_cells(21, 23)),    # Crimson Vine top up
    (8, get_clean_cells(27, 29)),    # Silver Fern top up
    (3, [c for c in get_clean_cells(15, 17) if (c[0]+c[1])%2==0]), # Blue Moss top up
]

cur_t = 467
for p_idx, cells_list in late_16:
